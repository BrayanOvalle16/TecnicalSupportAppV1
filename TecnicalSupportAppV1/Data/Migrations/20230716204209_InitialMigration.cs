        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactInformationId = table.Column<long>(type: "bigint", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_ContactInformations_ContactInformationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_Offices_OfficeId",
                        column: x => x.OfficeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Technicians_Offices_OfficeId",
                        column: x => x.OfficeId,
                        principalTable: "Offices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceOrders_Offices_OfficeId",
                        column: x => x.OfficeId,
                        principalTable: "Offices",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExternalItemId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TechnicianId = table.Column<long>(type: "bigint", nullable: true),
                    ItemId = table.Column<long>(type: "bigint", nullable: false),
                    StockAvailability = table.Column<int>(type: "int", nullable: true),
                    OfficeId = table.Column<long>(type: "bigint", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Stocks_Technicians_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "Technicians",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactInformations_IdentificationNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_OfficeId",
                table: "Items",
                column: "OfficeId");

            migrationBuilder.CreateIndex(
                name: "IX_Notes_StockId",
                table: "Notes",
                column: "StockId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrders_OfficeId",
                table: "ServiceOrders",
                column: "OfficeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocks_TechnicianId",
                table: "Stocks",
                column: "TechnicianId");

            migrationBuilder.CreateIndex(
                name: "IX_Technicians_OfficeId",
                table: "Technicians",
                column: "OfficeId");
